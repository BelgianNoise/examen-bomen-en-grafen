...
public class RecursieTest {
	...
	public void testOef5_CountHi_String_Met_1_Hi_Geeft_1() {
		assertEquals(1, Recursie.countX("hiabcx"));
	}
...
public void testOef9_FindMaximum_lijst_Met_Meer_Elementen_Geeft_Grootste() {
	...
	@Test
	public void testExtraOef1() {
		int[] myIntArray = {2,4,8};
		assertTrue(Recursie.groupSum(0,myIntArray,10));
		assertTrue(Recursie.groupSum(0,myIntArray,14));
		assertFalse(Recursie.groupSum(0,myIntArray,9));
	}
        @Test
        public void testExtraOef2() {
            int[] myIntArray =  {2, 5, 10, 4};
            assertTrue(Recursie.groupSum5(0,myIntArray,19));
            assertTrue(Recursie.groupSum5(0,myIntArray,17));
            assertFalse(Recursie.groupSum5(0,myIntArray,12));
        }
        @Test
        public void testExtraOef3() {
            int[] myIntArray = {5, 5, 5};
            assertTrue(Recursie.splitOdd10(myIntArray));
            int[] myIntArray2 = {5, 5, 6};
            assertFalse(Recursie.splitOdd10(myIntArray2));
            int[] myIntArray3 = {5, 5, 6,1};
            assertTrue(Recursie.splitOdd10(myIntArray3));
        }

	@Test
	public void testExtraOef4() {
		int[] myIntArray = {2, 2};
		assertTrue(Recursie.splitArray(myIntArray));
		int[] myIntArray2 = {2, 3, 6};
		assertFalse(Recursie.splitArray(myIntArray2));
		int[] myIntArray3 = {5, 2, 3};
		assertTrue(Recursie.splitArray(myIntArray3));
	}
}