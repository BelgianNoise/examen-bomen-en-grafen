...
public class BinarySearchTree<E extends Comparable<E>> {
	...
	public BinarySearchTree<E> deelZonder(E wortelinfo) {
		if (leftTree != null) {
			if (leftTree.data.equals(wortelinfo)) {
				this.leftTree = null;
				return this;
			}
		} else if (rightTree != null) {
			if (rightTree.data.equals(wortelinfo)) {
				this.rightTree = null;
				return this;
			}
		}
		...
		if(leftTree != null) {
			if(rightTree != null) {
				return new BinarySearchTree<E>(this.data, leftTree.deelZonder(wortelinfo),
						rightTree.deelZonder(wortelinfo));
			}else {
				return new BinarySearchTree<E>(this.data, leftTree.deelZonder(wortelinfo),
						null);
			}
		...
		if(rightTree != null && leftTree == null) {
			return new BinarySearchTree<E>(this.data, null,
					rightTree.deelZonder(wortelinfo));
		}
		return new BinarySearchTree<E>(this.data, null ,null);
	}
	...
	private BinarySearchTree(E data, BinarySearchTree<E> leftTree, BinarySearchTree<E> rightTree ) {
		this.data = data;
